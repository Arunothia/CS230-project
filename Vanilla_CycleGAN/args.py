...
def get_setup_args():
    ...
    parser.add_argument("--input_data_train_path", type=str, default="data/tempData/trainSet/", help="path to train data")
    parser.add_argument("--input_data_val_path", type=str, default="data/tempData/valSet/", help="path to val data")
    parser.add_argument("--input_data_piano_path", type=str, default="data/tempData/trainSet/pianoCqtChunks/", help="path to piano data directory")
    parser.add_argument("--input_data_flute_path", type=str, default="data/tempData/trainSet/fluteCqtChunks/", help="path to flute data directory")
